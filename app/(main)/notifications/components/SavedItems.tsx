...
export default function SavedItems({ itemsCount = 0 }: SavedItemsProps) {
  return (
    <section className="mt-5 w-full space-y-4">
      ...
      {itemsCount === 0 ? (
        /* Empty State View */
        <div className="flex w-full flex-col items-center justify-center rounded-2xl border border-slate-800 bg-secondary px-6 py-10 text-center">
          {/* Inner Icon Circle */}
          <div className="mb-5 flex h-22 w-22 items-center justify-center rounded-full border border-slate-800/50 bg-[#1b2335] text-slate-400">
